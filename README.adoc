image::https://badges.gitter.im/Join%20Chat.svg[Gitter, link="https://gitter.im/spring-cloud-incubator/spring-cloud-contract-raml?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge"]
